...
gulp.task('package', () => {
	del.sync(['../pkg/yamdbf-command-usage/**/*.*'], { force: true });
	gulp.src('bin/**/*.*').pipe(gulp.dest('../pkg/yamdbf-command-usage/bin'));
	gulp.src('package.json').pipe(gulp.dest('../pkg/yamdbf-command-usage'));
	gulp.src('README.md').pipe(gulp.dest('../pkg/yamdbf-command-usage'));
});
